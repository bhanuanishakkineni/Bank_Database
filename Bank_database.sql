...
CREATE TABLE `Account` (
    ...
    CONSTRAINT `account_ibfk_2` FOREIGN KEY (`card_id`)
        REFERENCES `Card` (`id`)
        ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `Customer_Branch` (
    ...
    CONSTRAINT `Customer_Branch_ibfk_1` FOREIGN KEY (`customer_id`)
        REFERENCES `Customer` (`id`),
    CONSTRAINT `Customer_Branch_ibfk_2` FOREIGN KEY (`branch_id`)
...
CREATE TABLE `Loan` (
    ...
    CONSTRAINT `loan_ibfk_1` FOREIGN KEY (`account_id`)
        REFERENCES `Account` (`id`)
        ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT `loan_ibfk_2` FOREIGN KEY (`loan_type_id`)
